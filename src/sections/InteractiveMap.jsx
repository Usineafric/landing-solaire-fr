...
export default function InteractiveMap() {
  ...
  const scrollToForm = () => {
    // ✅ Si on est déjà sur la home, scroll direct
    if (location.pathname === "/") {
      document.getElementById("form")?.scrollIntoView({ behavior: "smooth", block: "start" });
      return;
    }

    // ✅ Sinon, on navigue vers /#form (et ScrollToHash s'occupe du scroll)
    navigate("/#form");
  };
      ...
      <div className="container-page">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 font-light">
            Plus de <strong>2 800 installations</strong> réalisées depuis 2019 dans toutes les régions métropolitaines.
          </p>
        </div>
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-blue-50 to-orange-50 rounded-2xl flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">France Métropolitaine</h3>
                  <p className="text-gray-600 font-light">100% du territoire couvert</p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-orange-200 rounded-2xl p-6 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-gray-900">Service disponible partout en France</h3>
              </div>
              <p className="text-sm text-gray-700 font-light">
                Nos partenaires installateurs certifiés RGE interviennent dans toutes les régions pour votre projet
                solaire.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Votre région est couverte !</h3>
              <p className="text-gray-300 font-light mb-6">Demandez votre étude personnalisée gratuite</p>
